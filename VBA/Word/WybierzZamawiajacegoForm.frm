VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} WybierzZamawiajacegoForm 
   Caption         =   "Dodaj zamawiajacego"
   ClientHeight    =   2010
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   6210
   OleObjectBlob   =   "WybierzZamawiajacegoForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "WybierzZamawiajacegoForm"
...
Private Sub UserForm_Initialize()
    ...
    'sqlQuery = "SELECT id, nazwa_instytucji FROM ""bpWesley"".klienci;"
...
Private Sub LoadDataIntoComboBox(searchText As String)
    ...
    'Set sqlProvider = New SQLQueryProvider
    'sqlQuery = sqlProvider.SelectId_NazwaInstytucji
...
Private Sub btnSelect_Click()
    ...
    Dim sqlProvider As New SQLQueryProvider
   ' Dim sqlQuery As String
'    sqlQuery = sqlProvider.SelectClient(selectedText)
